 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(N,j){var B=N.length;N.push(j);e:for(;0<B;){var fe=B-1>>>1,Ie=N[fe];if(0<i(Ie,j))N[fe]=j,N[B]=Ie,B=fe;else break e}}function n(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var j=N[0],B=N.pop();if(B!==j){N[0]=B;e:for(var fe=0,Ie=N.length,zo=Ie>>>1;fe<zo;){var nr=2*(fe+1)-1,bu=N[nr],rr=nr+1,Bo=N[rr];if(0>i(bu,B))rr<Ie&&0>i(Bo,bu)?(N[fe]=Bo,N[rr]=B,fe=rr):(N[fe]=bu,N[nr]=B,fe=nr);else if(rr<Ie&&0>i(Bo,B))N[fe]=Bo,N[rr]=B,fe=rr;else break e}}return j}function i(N,j){var B=N.sortIndex-j.sortIndex;return B!==0?B:N.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,m=!1,y=!1,v=!1,w=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(N){for(var j=n(u);j!==null;){if(j.callback===null)r(u);else if(j.startTime<=N)r(u),j.sortIndex=j.expirationTime,e(l,j);else break;j=n(u)}}function _(N){if(v=!1,g(N),!y)if(n(l)!==null)y=!0,$u(C);else{var j=n(u);j!==null&&Uu(_,j.startTime-N)}}function C(N,j){y=!1,v&&(v=!1,p(D),D=-1),m=!0;var B=d;try{for(g(j),h=n(l);h!==null&&(!(h.expirationTime>j)||N&&!It());){var fe=h.callback;if(typeof fe=="function"){h.callback=null,d=h.priorityLevel;var Ie=fe(h.expirationTime<=j);j=t.unstable_now(),typeof Ie=="function"?h.callback=Ie:h===n(l)&&r(l),g(j)}else r(l);h=n(l)}if(h!==null)var zo=!0;else{var nr=n(u);nr!==null&&Uu(_,nr.startTime-j),zo=!1}return zo}finally{h=null,d=B,m=!1}}var R=!1,x=null,D=-1,J=5,z=-1;function It(){return!(t.unstable_now()-z<J)}function Bi(){if(x!==null){var N=t.unstable_now();z=N;var j=!0;try{j=x(!0,N)}finally{j?Wi():(R=!1,x=null)}}else R=!1}var Wi;if(typeof f=="function")Wi=function(){f(Bi)};else if(typeof MessageChannel<"u"){var Pp=new MessageChannel,rw=Pp.port2;Pp.port1.onmessage=Bi,Wi=function(){rw.postMessage(null)}}else Wi=function(){w(Bi,0)};function $u(N){x=N,R||(R=!0,Wi())}function Uu(N,j){D=w(function(){N(t.unstable_now())},j)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(N){N.callback=null},t.unstable_continueExecution=function(){y||m||(y=!0,$u(C))},t.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<N?Math.floor(1e3/N):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(N){switch(d){case 1:case 2:case 3:var j=3;break;default:j=d}var B=d;d=j;try{return N()}finally{d=B}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(N,j){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var B=d;d=N;try{return j()}finally{d=B}},t.unstable_scheduleCallback=function(N,j,B){var fe=t.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?fe+B:fe):B=fe,N){case 1:var Ie=-1;break;case 2:Ie=250;break;case 5:Ie=1073741823;break;case 4:Ie=1e4;break;default:Ie=5e3}return Ie=B+Ie,N={id:c++,callback:j,priorityLevel:N,startTime:B,expirationTime:Ie,sortIndex:-1},B>fe?(N.sortIndex=B,e(u,N),n(l)===null&&N===n(u)&&(v?(p(D),D=-1):v=!0,Uu(_,B-fe))):(N.sortIndex=Ie,e(l,N),y||m||(y=!0,$u(C))),N},t.unstable_shouldYield=It,t.unstable_wrapCallback=function(N){var j=d;return function(){var B=d;d=j;try{return N.apply(this,arguments)}finally{d=B}}}})(xy);Py.exports=xy;var Pw=Py.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rr=new mf("@firebase/firestore");function Vg(){return Rr.logLevel}function O(t,...e){if(Rr.logLevel<=G.DEBUG){const n=e.map(Xf);Rr.debug(`Firestore (${bi}): ${t}`,...n)}}function cn(t,...e){if(Rr.logLevel<=G.ERROR){const n=e.map(Xf);Rr.error(`Firestore (${bi}): ${t}`,...n)}}function Ti(t,...e){if(Rr.logLevel<=G.WARN){const n=e.map(Xf);Rr.warn(`Firestore (${bi}): ${t}`,...n)}}function Xf(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VE{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class EP{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(Ue.UNAUTHENTICATED))}shutdown(){}}class wP{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class TP{constructor(e){this.t=e,this.currentUser=Ue.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){let r=this.i;const i=l=>this.i!==r?(r=this.i,n(l)):Promise.resolve();let s=new nn;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new nn,e.enqueueRetryable(()=>i(this.currentUser))};const o=()=>{const l=s;e.enqueueRetryable(async()=>{await l.promise,await i(this.currentUser)})},a=l=>{O("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.auth.addAuthTokenListener(this.o),o()};this.t.onInit(l=>a(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?a(l):(O("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new nn)}},0),o()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(r=>this.i!==e?(O("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(re(typeof r.accessToken=="string"),new VE(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return re(e===null||typeof e=="string"),new Ue(e)}}class IP{constructor(e,n,r){this.l=e,this.h=n,this.P=r,this.type="FirstParty",this.user=Ue.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class SP{constructor(e,n,r){this.l=e,this.h=n,this.P=r}getToken(){return Promise.resolve(new IP(this.l,this.h,this.P))}start(e,n){e.enqueueRetryable(()=>n(Ue.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class AP{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class CP{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,n){const r=s=>{s.error!=null&&O("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${s.error.message}`);const o=s.token!==this.R;return this.R=s.token,O("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?n(s.token):Promise.resolve()};this.o=s=>{e.enqueueRetryable(()=>r(s))};const i=s=>{O("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=s,this.appCheck.addTokenListener(this.o)};this.A.onInit(s=>i(s)),setTimeout(()=>{if(!this.appCheck){const s=this.A.getImmediate({optional:!0});s?i(s):O("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(re(typeof n.token=="string"),this.R=n.token,new AP(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Oo(t){if(t.code!==T.FAILED_PRECONDITION||t.message!==DP)throw t;O("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $e="WebChannelConnection";class hx extends class{constructor(n){this.databaseInfo=n,this.databaseId=n.databaseId;const r=n.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.To=r+"://"+n.host,this.Eo=`projects/${i}/databases/${s}`,this.Ao=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${s}`}get Ro(){return!1}Vo(n,r,i,s,o){const a=Dc(),l=this.mo(n,r);O("RestConnection",`Sending RPC '${n}' ${a}:`,l,i);const u={"google-cloud-resource-prefix":this.Eo,"x-goog-request-params":this.Ao};return this.fo(u,s,o),this.po(n,l,u,i).then(c=>(O("RestConnection",`Received RPC '${n}' ${a}: `,c),c),c=>{throw Ti("RestConnection",`RPC '${n}' ${a} failed with error: `,c,"url: ",l,"request:",i),c})}yo(n,r,i,s,o,a){return this.Vo(n,r,i,s,o)}fo(n,r,i){n["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+bi}(),n["Content-Type"]="text/plain",this.databaseInfo.appId&&(n["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((s,o)=>n[o]=s),i&&i.headers.forEach((s,o)=>n[o]=s)}mo(n,r){const i=ux[n];return`${this.To}/v1/${r}:${i}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}po(e,n,r,i){const s=Dc();return new Promise((o,a)=>{const l=new vP;l.setWithCredentials(!0),l.listenOnce(mP.COMPLETE,()=>{try{switch(l.getLastErrorCode()){case xc.NO_ERROR:const c=l.getResponseJson();O($e,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(c)),o(c);break;case xc.TIMEOUT:O($e,`RPC '${e}' ${s} timed out`),a(new V(T.DEADLINE_EXCEEDED,"Request time out"));break;case xc.HTTP_ERROR:const h=l.getStatus();if(O($e,`RPC '${e}' ${s} failed with status:`,h,"response text:",l.getResponseText()),h>0){let d=l.getResponseJson();Array.isArray(d)&&(d=d[0]);const m=d==null?void 0:d.error;if(m&&m.status&&m.message){const y=function(w){const p=w.toLowerCase().replace(/_/g,"-");return Object.values(T).indexOf(p)>=0?p:T.UNKNOWN}(m.status);a(new V(y,m.message))}else a(new V(T.UNKNOWN,"Server responded with status "+l.getStatus()))}else a(new V(T.UNAVAILABLE,"Connection failed."));break;default:F()}}finally{O($e,`RPC '${e}' ${s} completed.`)}});const u=JSON.stringify(i);O($e,`RPC '${e}' ${s} sending request:`,i),l.send(n,"POST",u,r,15)})}wo(e,n,r){const i=Dc(),s=[this.To,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=fP(),a=pP(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.xmlHttpFactory=new yP({})),this.fo(l.initMessageHeaders,n,r),l.encodeInitMessageHeaders=!0;const c=s.join("");O($e,`Creating RPC '${e}' stream ${i}: ${c}`,l);const h=o.createWebChannel(c,l);let d=!1,m=!1;const y=new cx({so:w=>{m?O($e,`Not sending because RPC '${e}' stream ${i} is closed:`,w):(d||(O($e,`Opening RPC '${e}' stream ${i} transport.`),h.open(),d=!0),O($e,`RPC '${e}' stream ${i} sending:`,w),h.send(w))},oo:()=>h.close()}),v=(w,p,f)=>{w.listen(p,g=>{try{f(g)}catch(_){setTimeout(()=>{throw _},0)}})};return v(h,da.EventType.OPEN,()=>{m||O($e,`RPC '${e}' stream ${i} transport opened.`)}),v(h,da.EventType.CLOSE,()=>{m||(m=!0,O($e,`RPC '${e}' stream ${i} transport closed`),y.Po())}),v(h,da.EventType.ERROR,w=>{m||(m=!0,Ti($e,`RPC '${e}' stream ${i} transport errored:`,w),y.Po(new V(T.UNAVAILABLE,"The operation could not be completed")))}),v(h,da.EventType.MESSAGE,w=>{var p;if(!m){const f=w.data[0];re(!!f);const g=f,_=g.error||((p=g[0])===null||p===void 0?void 0:p.error);if(_){O($e,`RPC '${e}' stream ${i} received error:`,_);const C=_.status;let R=function(J){const z=me[J];if(z!==void 0)return s1(z)}(C),x=_.message;R===void 0&&(R=T.INTERNAL,x="Unknown error status: "+C+" with message "+_.message),m=!0,y.Po(new V(R,x)),h.close()}else O($e,`RPC '${e}' stream ${i} received:`,f),y.Io(f)}}),v(a,gP.STAT_EVENT,w=>{w.stat===Dg.PROXY?O($e,`RPC '${e}' stream ${i} detected buffering proxy`):w.stat===Dg.NOPROXY&&O($e,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{y.ho()},0),y}}function Oc(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.d_?(cn(n),this.d_=!1):O("OnlineStateTracker",n)}f_(){this.E_!==null&&(this.E_.cancel(),this.E_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,ya=16,nw=({reverseOrder:t,position:e="top-center",toastOptions:n,gutter:r,children:i,containerStyle:s,containerClassName:o})=>{let{toasts:a,handlers:l}=GN(n);return I.createElement("div",{style:{position:"fixed",zIndex:9999,top:ya,left:ya,right:ya,bottom:ya,pointerEvents:"none",...s},className:o,onMouseEnter:l.startPause,onMouseLeave:l.endPause},a.map(u=>{let c=u.position||e,h=l.calculateOffset(u,{reverseOrder:t,gutter:r,defaultPosition:e}),d=vD(c,h);return I.createElement(yD,{id:u.id,key:u.id,onHeightUpdate:l.updateHeight,className:u.visible?_D:"",style:d},u.type==="custom"?$l(u.message,u):i?i(u):I.createElement(gD,{toast:u,position:c}))}))};function ED(){const t=ff(),e=Mu(),[n,r]=I.useState(""),[i,s]=I.useState(""),o=async a=>{try{a.preventDefault();const l=he.loading("Espere un momento..."),u=await e.login(n,i);return u.success?t("/clinic/"):(he.dismiss(l),u.error=="Firebase: Error (auth/wrong-password)."||u.error=="Firebase: Error (auth/user-not-found)."?he.error("Usuario o Contraseña Incorrecta."):u.error=="Firebase: Access to this account has been temporarily disabled due to many failed login attempts. You can immediately restore it by resetting your password or you can try again later. (auth/too-many-requests)."?he.error("El acceso a esta cuenta ha sido desactivado temporalmente debido a muchos intentos fallidos de inicio de sesión. "):he.error("Existe un error: "+u.error))}catch(l){console.log(l)}};return E.jsx("div",{className:"min-h-screen flex justify-center items-center",children:E.jsxs("form",{action:"",className:"max-w-md w-10/12  h-72 flex flex-col items-center  bg-slate-100 text-slate-900 rounded-xl shadow-sm py-4 px-8 m-auto",children:[E.jsx("h3",{className:"font-semibold text-xl text-center uppercase pt-4 pb-6",children:"Inicio de Sesión"}),E.jsxs("div",{className:"w-full flex flex-col justify-center gap-5",children:[E.jsxs("div",{className:"w-full flex flex-col gap-2",children:[E.jsx(Fl,{id:"input-email",type:"text",text:"Ingresar Correo..",handleChange:r}),E.jsx(Fl,{id:"input-pass",type:"password",text:"Ingresar Contraseña..",handleChange:s})]}),E.jsx(kp,{type:!0,text:"Iniciar Session",handleClick:o})]}),E.jsx(nw,{position:"bottom-center"})]})})}const wD=async({fullName:t,identity:e})=>{try{const n=await X1(_p(bo,"Users"),{fullName:t,identity:e,date:new Date});return console.log("Document written with ID: ",n.id),n}catch(n){return{success:!1,error:n.message}}},my=async(t,e)=>{try{const n=Ep(bo,"Users",t.id),r=await yN(n);if(console.log("Id de la cita: ",e),console.log("Usuario: ",r),console.log(!r.data().appointments),!r.data().appointments){const o=await hd(n,{appointments:[e]});return console.log(o),o}let i=r.data().appointments;i.push(e);const s=await hd(n,{appointments:i});return console.log(s),s}catch(n){return n}},TD=async(t,e)=>{try{const n=Ep(bo,"Appointments",t);if(!n)throw new Error("No se ah conseguido esta cita");return await hd(n,e),{success:!0}}catch(n){return{success:!1,error:n.message}}},gy=async(t,{price:e,date:n})=>{try{return await X1(_p(bo,"Appointments"),{idUser:t,date:n,price:e})}catch(r){return console.error("Error adding document: ",r),r}},yy=async t=>{const e=await vN(_p(bo,t));let n=[];return e.forEach(r=>{n.push({id:r.id,...r.data()})}),n};function ID({id:t,citaId:e,today:n,identity:r,fullName:i,price:s}){const o=n+"-"+t;console.log(o);const a=l=>{l.preventDefault();const u=document.querySelector("#form-Appointment");u.setAttribute("data-appointment",e),u.querySelector("#identity").value=r,u.querySelector("#fullName").value=i,u.querySelector("#price").value=s};return E.jsx("div",{className:"text-sm px-2",children:E.jsxs("div",{className:"flex justify-between items-center bg-slate-800/60 border-b border-slate-700 py-1 px-4",children:[E.jsxs("div",{id:o,className:"flex justify-between items-center gap-4",children:[E.jsx("h4",{children:i}),E.jsxs("strong",{children:[s,"$"]})]}),E.jsx("button",{onClick:l=>{a(l)},children:E.jsx(RN,{})})]})},t)}function SD({usersAll:t,mountAll:e}){return E.jsx("div",{className:"text-sm px-2",children:E.jsxs("div",{className:"flex justify-between items-center bg-slate-800/60 rounded-b-md py-1 px-4",children:[E.jsxs("h4",{children:["Clientes Total: ",E.jsx("strong",{children:t})]}),E.jsxs("h4",{children:["Ganacia Total: ",E.jsx("strong",{children:e})]})]})})}function AD({date:t,i:e,toggleVisibility:n}){const r=i=>{i.preventDefault(),n(e)};return E.jsxs("header",{className:"flex justify-between items-center bg-slate-800 rounded-md py-1 px-2",children:[E.jsx("h4",{children:t}),E.jsx("button",{onClick:i=>{r(i)},children:E.jsx(CN,{})})]})}function CD({datos:t}){const e=s=>s.reduce((a,l)=>l.price?a+l.price:a,0),[n,r]=I.useState([]),i=s=>{r(o=>{const a=[...o];return a[s]=!a[s],a})};return E.jsx(E.Fragment,{children:t&&t.map((s,o)=>E.jsxs("div",{className:"grid gap-1",children:[E.jsx(AD,{date:s.fecha,i:o,toggleVisibility:i}),n[o]&&E.jsxs("div",{children:[s.citas.map(a=>E.jsx("div",{children:a.pacientes.map(l=>E.jsx("div",{children:l&&E.jsx(ID,{id:l.id,citaId:a.citaId,today:s.fecha,identity:l.identity,fullName:l.fullName,price:a.price})},l.id))},a.citaId)),E.jsx(SD,{usersAll:s.citas.length,mountAll:e(s.citas)})]})]},o))})}function RD(){const t=new Date,n=["Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado"][t.getDay()],r=t.getDate(),i=t.getMonth()+1,s=t.getFullYear();return`${n} ${r<10?"0"+r:r}/${i<10?"0"+i:i}/${s}`}const kD=(t,e)=>{const n={};return e.forEach(s=>{const o=s.date.substring(0,10),a=t.find(u=>u.id===s.idUser);if(!a)return;const l=a.appointments.filter(u=>u===s.id).map(()=>({...a}));n[o]||(n[o]=[]),n[o].push({citaId:s.id,price:s.price,pacientes:l})}),Object.keys(n).sort().map(s=>({fecha:s,citas:n[s]}))};function Lc(){var t=new Date,e=t.getDate(),n=t.getMonth()+1,r=t.getFullYear();t.getHours(),t.getMinutes(),e<10&&(e="0"+e),n<10&&(n="0"+n);var i=""+e+"/"+n+"/"+r;return i}const PD=({users:t})=>{const[e,n]=I.useState(!1),[r,i]=I.useState([]),s=a=>{const l=a.target.value;n(l);const u=t.filter(c=>c.identity.includes(l));i(u)},o=a=>{a.preventDefault();const l=a.target.dataset.identity,u=a.target.dataset.name;document.getElementById("identity").value=l,document.getElementById("fullName").value=u,n(!1)};return E.jsxs("div",{className:"relative w-full flex gap-2 border-2 border-yellow-400 text-slate-900 rounded-full px-3 py-1 focus-within:border-yellow-900",children:[E.jsx(kN,{}),E.jsx("input",{id:"identity",className:"w-full bg-transparent border-none focus:border-none focus-visible:outline-none",type:"text",placeholder:"Ingresar Cedula",onChange:s}),E.jsx("ul",{className:"absolute top-full w-full bg-slate-100 text-900 mt-2",children:e&&r.map(a=>E.jsx("li",{onClick:l=>o(l),"data-identity":a.identity,"data-name":a.fullName,className:"hover:bg-slate-200 cursor-pointer",children:a.identity},a.id))})]})};function xD(){const t=Mu(),{displayName:e}=t.user,[n,r]=I.useState([]),[i,s]=I.useState([]),[o,a]=I.useState([]),l=async()=>{const c=await yy("Users"),h=await yy("Appointments");s(c),a(h);const d=kD(c,h);r(d)};I.useEffect(()=>{l()},[]);const u=async c=>{try{c.preventDefault();const h=he.loading("Espere un momento..."),d=document.getElementById("form-Appointment"),m=d.querySelector("#identity").value,y=d.querySelector("#fullName").value,v=Number(d.querySelector("#price").value);if(!m||!y||!v)return he.error("Asegurate de ingresar los datos requeridos.");let w;const p=d.dataset.appointment;if(p)console.log("Actualizando precio de la cita."),(await TD(p,{price:v})).success&&(d.removeAttribute("data-appointment"),w="Se ah actualizado la cita con su paciente corespondiente.");else{const f=i.filter(g=>g.identity.includes(m))[0];if(f){const g=Lc(),_=o.filter(D=>D.date.includes(g));if(console.log(g),console.log(_),_.filter(D=>D.idUser.includes(f.id)).length>0)return console.log("Este usuario tiene una cita. puede actalizarla.");console.log("asignando cita al usuario");const R=await gy(f.id,{price:v,date:Lc()}),x=await my(f,R.id);w="Se le ah asigando una cita a este paciente"}else{const g=await wD({identity:m,fullName:y}),_=await gy(g.id,{price:v,date:Lc()}),C=await my(g,_.id);w="Se a registrado un nuevo paciente y se le ah asigando una cita."}}return d.reset(),l(),he.dismiss(h),he(w)}catch(h){he.error("Ah ocurrido un error: "+h)}};return E.jsxs("header",{className:"flex flex-col",children:[E.jsxs("h1",{className:"text-2xl font-black uppercase py-8",children:["¡Bienvenido, ",e||"Administrador","!"]}),E.jsxs("div",{className:"flex flex-wrap justify-around gap-6 p-4",children:[E.jsx("h2",{className:"w-full text-lg text-center font-light mb-4",children:"Control de Pacientes"}),E.jsx("form",{id:"form-Appointment",className:"w-full md:w-5/12 max-w-md h-72 bg-slate-100 text-slate-900 rounded-md shadow-md py-8 px-6","data-user":"","data-appointment":"",children:E.jsxs("div",{className:"flex flex-col justify-center gap-4",children:[E.jsx("h3",{className:"text-center font-semibold",children:RD()}),E.jsx(PD,{users:i}),E.jsx(Fl,{id:"fullName",type:"text",text:"Ingresar Nombre...",children:E.jsx(SN,{})}),E.jsx(Fl,{id:"price",type:"text",text:"Ingresar Monto...",children:E.jsx(AN,{})}),E.jsx(kp,{type:!0,handleClick:u,text:"Guardar",children:E.jsx(IN,{})})]})}),E.jsxs("form",{className:"w-full md:w-6/12 px-6 ",children:[E.jsx("h3",{className:"text-center font-semibold mb-4",children:"Historial"}),E.jsx("div",{className:"grid gap-4",children:E.jsx(CD,{datos:n})})]})]}),E.jsx(nw,{})]})}function ND(){const e=Mu().user;return e===null?E.jsxs("div",{className:"min-h-screen flex items-center justify-center",children:[E.jsxs("svg",{"aria-hidden":"true",className:"w-12 h-12 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-yellow-600",viewBox:"0 0 100 101",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[E.jsx("path",{d:"M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z",fill:"currentColor"}),E.jsx("path",{d:"M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z",fill:"currentFill"})]}),E.jsx("span",{className:"sr-only",children:"Loading..."})]}):E.jsxs("main",{className:"min-h-screen grid gap-20 pt-20 px-12",children:[E.jsx(PN,{}),E.jsx(ES,{children:e?E.jsx(xa,{path:"/clinic/",element:E.jsx(xD,{})}):E.jsxs(E.Fragment,{children:[E.jsx(xa,{path:"/clinic/",element:E.jsx(xN,{})}),E.jsx(xa,{path:"/clinic/Login",element:E.jsx(ED,{})})]})})]})}const DD=document.querySelector("body");DD.className="grid min-h-screen bg-slate-900 text-slate-100 m-0";const OD=document.getElementById("root"),VD=Mc.createRoot(OD);VD.render(E.jsx(CS,{children:E.jsx(wN,{children:E.jsx(ND,{})})}));
